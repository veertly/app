...
export default function (props) {
  ...
  const [conversationsExpanded, setConversationsExpanded] = React.useState(
    true
  );
  ...
  const toggleExpandRooms = React.useCallback(
    () => setRoomsExpanded(!roomsExpanded),
    [roomsExpanded]
  );
  const toggleExpandConversations = React.useCallback(
    ...
    <div className={classes.root}>
      ...
      <div className={classes.relativeContainer}>
        ...
        <div className={classes.title} onClick={toggleExpandConversations}>
          <div className={classes.expandIcon}>
            {conversationsExpanded ? <ExpandLess /> : <ExpandMore />}
          </div>
          <Typography color="secondary" align="left">
            CONVERSATIONS
          </Typography>
        ...
        <Collapse in={conversationsExpanded} timeout="auto" unmountOnExit>
          ...
          {numConversations === 0 && (
            ...
            >
              ...
              There are no conversations yet, check out the topic rooms or
              select someone and start networking!
            </Typography>
          )}
        </Collapse>
